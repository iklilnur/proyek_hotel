...
<body>
    ...
    <div class="container">
        ...
        <form action="/pegawai/update_reservasi" method="post" class="form-pegawai">
            {{ csrf_field() }}
            ...
            @if($data['jenis_pembayaran'] == "Bayar diakhir")
                ...
                <div class="form-group">
                    <input type="text" class="form-control" name="uang_muka" min="{{ $data['uang_muka'] }}" required>
                </div>
                <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="hidden" value="{{$data['no_reservasi']}}" name="no_reservasi">
                <a href="/pegawai/edit_reservasi/{{ $data['no_reservasi'] }}" class="btn btn-danger">Kembali</a>
